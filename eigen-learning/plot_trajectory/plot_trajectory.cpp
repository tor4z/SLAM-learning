...
const std::string trajectory_file = "../asset/trajectory.txt";
...
{
    pangolin::CreateWindowAndBind("Trajectory Window", 1024, 768);
...
int main(int argc, char **argv)
{
    ...
    if(!fin)
    {
        std::cerr << "Can not find trajectory file at: " << trajectory_file << std::endl;
        return 1;
    }
